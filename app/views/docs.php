<section class="shell page-docs">
  ...
  <article class="doc-block">
    <h2>Plans &amp; pricing</h2>
    <p><strong>Free hosted ($0)</strong> lets you try the builder with fair limits. <strong>Company self-host / full source</strong> is a premium private license — not listed as a public store dump. Interested? Send us a DM from <a href="https://northstarscripts.us/">northstarscripts.us</a>. Optional hosted Standard/Pro upgrades may come later if you want us to run the cloud.</p>
  </article>
  ...
  <article class="doc-block">
    ...
    <ul>
      ...
      <li><strong>Self-host / source license</strong> — private inquiry (DM) for companies and serious operators.</li>
    </ul>
